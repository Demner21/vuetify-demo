...
<template>
  <v-row>
    <v-col cols="6">
      <v-card
        :title="promocionAdquirida.idConcepto"
        :subtitle="promocionAdquirida.idConcepto"
      >
        ...
        <v-card-text class="mt-0 pa-0"> Counter: NATH </v-card-text>
        <v-card-actions>
          <v-btn
            color="orange-darken-4"
            @click="obtenerPagoAsociado()"
            class="primary"
            text="Pago Asociado"
          ></v-btn>
        </v-card-actions>
